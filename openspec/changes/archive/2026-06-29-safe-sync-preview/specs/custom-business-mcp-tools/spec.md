...
(Previously: `sync_product` prepared pending proposals and explicitly allowed no sync preview evidence.)
...
- GIVEN durable storage cannot be opened during MCP startup
- WHEN `sync_product` prepares a valid proposal
