...
| **Specialist Daemons**               | 14 daemon handlers on 15-min schedule      | Dispatched through Agent Message Bus. Investigate evidence, propose to CEO, never mutate. Six lanes support Work Session routing.      |
...
│   │       ├── workers/
│   │       │   ├── daemonScheduler.ts          # 14-handler daemon scheduler
