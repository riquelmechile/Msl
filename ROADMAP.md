...
| MCP               | **✅ 21 MCP tools** — 10 original + 11 new (read_moderation_status, read_notices, prepare_answer, read_claims, read_claim_detail, read_shipment_status, read_claim_messages, read_claim_expected_resolutions, read_claim_affects_reputation, read_claim_status_history, prepare_image_orchestration). All tools run but MercadoLibre calls use stub mode without real credentials. |
...
| CI                | Format, typecheck, lint, Vitest (944 tests), Playwright E2E (7 specs), and build gates run in CI.                                                                                                                                                                                                                           |
| ML API coverage   | **✅ 39 MlcApiClient methods** across 12 API areas: listings, orders, messages, reputation, categories, pricing, promotions, visits, performance, product ads, image diagnostics/upload, moderation status, notices, claims, shipping, image orchestration. All 6 new 2025-2026 endpoints confirmed MLC-compatible.        |
