...
import type {
  ...
  MlcVisitsSummary,
  MlcVisitsSnapshot,
  MlcVisitsTimeWindowSummary,
  MlcVisitsTimeWindowSnapshot,
  MlcPerformanceRule,
  MlcPerformanceVariable,
  MlcPerformanceBucket,
  MlcPerformanceSummary,
  MlcPerformanceSnapshot,
  MlcRelistResult,
  MlcRelistSnapshot,
  MlcImageDetection,
  MlcImageDiagnosticResult,
  MlcImageDiagnosticSummary,
  MlcImageDiagnosticSnapshot,
  MlcImageUploadResult,
  MlcImageUploadSnapshot,
  MlcImageOrchestrationStep,
  MlcImageOrchestrationSummary,
  MlcModerationStatusSummary,
  ...
  MlcAnswerSnapshot,
  MlcClaimPlayer,
  MlcClaimPlayerAction,
  MlcClaimResolution,
  MlcClaimMessage,
  MlcClaimSummary,
  MlcClaimsSearchResult,
  MlcClaimsSearchSnapshot,
  MlcClaimDetailSummary,
  MlcClaimDetailSnapshot,
  MlcClaimMessagesSummary,
  MlcClaimMessagesSnapshot,
  MlcClaimResolutionsSummary,
  MlcClaimResolutionsSnapshot,
  MlcClaimReputationSummary,
  MlcClaimReputationSnapshot,
  MlcClaimStatusHistorySummary,
  MlcClaimStatusHistorySnapshot,
  MlcRateLimitBlockedMetadata,
  MlcShipmentStatusSummary,
  MlcShipmentStatusSnapshot,
  MlcReturnSnapshotBase,
  MlcReturnSummary,
  MlcClaimReturnSummary,
  MlcClaimReturnSnapshot,
  MlcReturnReview,
  MlcReturnReviewsSummary,
  MlcReturnReviewsSnapshot,
  MlcReturnCostCharge,
  MlcClaimReturnCostSummary,
  ...
  MlcProductAdsMetricSummary,
  MlcProductAdsEntitySummary,
  ...
  MlcItemSalePriceSummary,
  MlcItemSalePriceSnapshot,
  MlcItemPriceConditionsSummary,
  MlcItemPricesSummary,
  MlcItemPricesSnapshot,
  MlcPriceToWinWinnerSummary,
  MlcPriceToWinBoostSummary,
  MlcPriceToWinSummary,
  MlcPriceToWinSnapshot,
  MlcPricingAutomationSummary,
  MlcPricingAutomationSnapshot,
  MlcPricingAutomationRulesSummary,
  MlcPricingAutomationRulesSnapshot,
  MlcPricingAutomationHistorySummary,
  MlcPricingAutomationHistorySnapshot,
  MlcAutomatedPriceItemsSummary,
  MlcAutomatedPriceItemsSnapshot,
  MlcPromotionBenefitsSummary,
  MlcPromotionSummary,
  MlcPromotionParticipantSummary,
  MlcItemPromotionStockSummary,
  MlcItemPromotionSummary,
  MlcSellerPromotionsSummary,
  MlcSellerPromotionsSnapshot,
  MlcPromotionDetailSnapshot,
  MlcPromotionItemsSummary,
  MlcPromotionItemsSnapshot,
  MlcItemPromotionsSnapshot,
  MlcSingleReadSnapshot,
