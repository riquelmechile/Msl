...
// ── Helpers ───────────────────────────────────────────────────────────
function makeQuestion(text, overrides = {}) {
    return {
        text,
...
describe("analyzeQuestions", () => {
    ...
    it("detects new_competitor from detailed business questions by low-activity user", () => {
        const alerts = analyzeQuestions([
            makeQuestion("¿Cómo calculás el margen de ganancia en la categoría de electrónica " +
                "y cuánto stock manejás por producto?", { from: "cuenta-nueva-1" }),
        ]);
...
//# sourceMappingURL=probeDetector.test.js.map