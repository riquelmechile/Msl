    ...
    it("records KPI after confirmed dale", async () => {
        ...
        const state = makeState({
            messages: [
                ...
                {
                    role: "assistant",
                    content: "Analicé tus márgenes. Te preparo una propuesta de ajuste para el listing MLC-42.",
        ...
        const rows = db.prepare("SELECT * FROM kpi_history").all();
...
//# sourceMappingURL=autonomyIntegration.test.js.map