...
// ── Skill tool factories (Phase B) ─────────────────────────────────

export type SkillToolOptions = {
  authorized?: boolean;
};

function summarizeAgentSkill(skill: AgentSkill) {
  return {
...
const validSkillCategories: readonly string[] = [
  "technical",
  "domain",
  "analysis",
  "creative",
...
// ── Agent lifecycle tool factory (Phase C) ──────────────────────
